    ...
    <CustomKeyboardView>
      ...
      <View style={{paddingTop: hp(6), paddingHorizontal: wp(5)}} className='flex-1 gap-12'>
        <View className='items-center'>
          <Image style={{height: hp(35)}} resizeMode='contain' source={require ('../assets/images/signup.png')} />
        </View>
          ...
          <View className='gap-4'>
            ...
            <View>
              {
                loading?(
                  ...
                  <TouchableOpacity onPress={handleRegister} style={{height :hp(6.5)}} className='bg-pink-300 rounded-xl justify-center items-center'>
            ...
            <View className='flex-row justify-center pb-5'>
              ...
              <Pressable onPress={() => router.push('/signIn')}>
                <Text style={{fontSize: hp(1.8)}} className='font-bold text-pink-300'>Sign In</Text>
              </Pressable>
            </View>
