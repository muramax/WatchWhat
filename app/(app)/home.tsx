...
export default function home() {
  ...
  const blocks = [
    { key: "add", component: <AddBlock /> },
    { key: "update", component: <UpdateBlock /> },
    { key: "delete", component: <DeleteBlock /> },
    { key: "deleteAll", component: <DeleteAllBlock /> },
  ];
  ...
  return (
    <CustomKeyboardView>
      ...
      <FlatList
        data={blocks}
        key={numColumns} // force rerender when numColumns changes
        numColumns={numColumns}
        renderItem={({ item }) => (
          <View style={{ flex: 1, margin: 8 }}>{item.component}</View>
        )}
      />
    </CustomKeyboardView>
  );
